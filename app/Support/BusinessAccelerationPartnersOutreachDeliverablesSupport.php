...
final class BusinessAccelerationPartnersOutreachDeliverablesSupport
{
    private const TABLE = 'business_acceleration_partner_outreach_entries';
    ...
    public static function breakdown(?Carbon $periodFrom, ?Carbon $periodTo): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $records[] = [
                ...
                'applicant' => BusinessAccelerationPartnersOutreachOptions::partnerTypeLabel(
                    (string) $row->partner_type,
                    $row->partner_type_other
                ),
                'district' => 'State',
                'hub' => '—',
                'service' => BusinessAccelerationPartnersOutreachOptions::outreachModeLabel((string) $row->outreach_mode),
                'spoc' => (string) ($row->submitted_by_name ?: '—'),
                'status' => (string) ($row->poc_name ?: '—'),
                'date' => $displayDate,
            ];
        }
