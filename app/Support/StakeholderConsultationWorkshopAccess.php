...
final class StakeholderConsultationWorkshopAccess
{
    /**
     * @return list<string>
     */
    ...
    {
        $emails = config('muy.stakeholder_consultation_workshop_submitters', []);
    ...
    public static function canEdit(?User $user, StakeholderConsultationWorkshop $row): bool
    {
    ...
    public static function canDelete(?User $user, StakeholderConsultationWorkshop $row): bool
    {
