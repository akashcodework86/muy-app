...
class ProgramDeliverableCodeLookup
{
    ...
    private function lookupCodesFromSource(array $source): array
    {
        return match ($source['type'] ?? 'none') {
            ...
            'technical_training_potential_lakhpati_sessions', 'technical_training_potential_lakhpati_participations', 'community_org_outreach_count', 'marketing_partner_outreach_count', 'marketing_partner_onboarded_count', 'business_acceleration_partners_outreach_count', 'capacity_building_stakeholder_sessions', 'pitch_deck_preparations', 'pitch_deck_combined', 'demo_days_count', 'funding_schematic_partners_outreach_count' => array_filter([(string) ($source['deliverable_code'] ?? '')]),
