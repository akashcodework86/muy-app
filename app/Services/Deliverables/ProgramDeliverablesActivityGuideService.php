...
class ProgramDeliverablesActivityGuideService
{
    ...
    private function moduleBySourceType(string $sourceType, array $source, string $role): array
    {
        ...
        return match ($sourceType) {
            ...
            'pitch_deck_preparations', 'pitch_deck_combined' => $pick('services.create', 'Service → New service case', 'District staff tick Through REAP on convergence service cases; state team entries on pitch deck module.', 'pitch-deck-preparations.dashboard'),
    ...
    private function achievementSourceLabel(string $sourceType): string
    {
        return match ($sourceType) {
            ...
            'pitch_deck_preparations', 'pitch_deck_combined' => '8.3 Incubatees Pitch Deck Preparation (convergence Through REAP + state team)',
