...
class ProgramDeliverablesActivityGuideService
{
    ...
    private function moduleBySourceType(string $sourceType, array $source, string $role): array
    {
        ...
        return match ($sourceType) {
            ...
            'schematic_convergence_services' => $pick('services.create', 'Service → New service case', 'Approved convergence and REAP-support service cases count toward MIS 8.1.', 'phase3-services.index'),
            ...
            'marketing_partner_outreach_count', 'marketing_partner_onboarded_count' => $pick('partner-outreach.dashboard', 'Partner outreach (6.1 / 6.2)', 'Sanjna logs partner outreach; onboard via LoA/LoI/MoU on detail page. District staff may also submit approved service cases.', 'partner-outreach.dashboard'),
            ...
            'acceleration_services_initiation_count' => $pick('acceleration-services.dashboard', '7.2 Acceleration services', 'Ankur Rawat logs acceleration & co-incubation initiation for Phase 1 applicants.', 'acceleration-services.dashboard'),
    ...
    private function achievementSourceLabel(string $sourceType): string
    {
        return match ($sourceType) {
            ...
            'schematic_convergence_services' => 'Schematic convergence service cases (MIS 8.1)',
