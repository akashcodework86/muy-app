...
class ProgramDeliverablesActivityGuideService
{
    ...
    private function moduleBySourceType(string $sourceType, array $source, string $role): array
    {
        ...
        return match ($sourceType) {
            ...
            'acceleration_services_initiation_count' => $pick('acceleration-services.create', '7.2 Acceleration services', 'Ankur Rawat logs acceleration & co-incubation initiation for Phase 1 applicants.', 'acceleration-services.dashboard'),
