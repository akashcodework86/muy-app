...
class FieldCoordinatorAttendanceController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        FieldCoordinatorAttendanceReport::query()->create([
            ...
            'participants_male_count' => (int) $validated['participants_male_count'],
            'participants_female_count' => (int) $validated['participants_female_count'],
            'participants_total' => (int) $validated['participants_male_count'] + (int) $validated['participants_female_count'],
            'cfas_filled_total' => 0,
