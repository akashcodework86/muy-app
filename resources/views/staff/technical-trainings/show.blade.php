...
@section('title', 'Technical training entry')
    ...
    <div class="tp-show-card">
        ...
        <div class="tp-show-grid">
            ...
            <div class="tp-show-field">
                ...
                <span class="tp-show-field__value">{{ $row->session_name }}</span>
            </div>
            <div class="tp-show-field tp-show-field--full">
                <span class="tp-show-field__label">Session Brief</span>
                <span class="tp-show-field__value">{{ $row->session_brief ?: '—' }}</span>
            </div>
            <div class="tp-show-field">
        ...
        <div class="tp-show-actions">
            <a class="tp-show-btn tp-show-btn--primary" href="{{ match ($currentRole) {
                'state_admin' => route('admin.technical-trainings.export-single', $row),
                'state_staff' => route('spoc.technical-trainings.export-single', $row),
                default => route('staff.technical-trainings.export-single', $row),
            } }}">Excel Export</a>
            @if ($canEdit)
                <a class="tp-show-btn tp-show-btn--secondary" href="{{ route('staff.technical-trainings.edit', $row) }}">Edit Entry</a>
            @endif
            <a class="tp-show-btn tp-show-btn--secondary" href="{{ match ($currentRole) {
                'state_admin' => route('admin.technical-trainings.dashboard'),
                'state_staff' => route('spoc.technical-trainings.dashboard'),
                default => route('staff.technical-trainings.dashboard'),
            } }}">Back to dashboard</a>
        </div>
    </div>
