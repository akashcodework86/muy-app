                                ...
                                @if ($cfaCount > 0 && $cfaCount >= $reported)
                                    <div class="cfa-status-cell cfa-status-cell--match">
                                        ...
                                        <div class="cfa-status-brief">
                                            Referral CFAs on this visit date meet or exceed reported ({{ $reported }}).
                                        </div>
                                    </div>
                                @elseif ($cfaCount > 0)
                                    <div class="cfa-status-cell cfa-status-cell--mismatch">
                                        ...
                                        <div class="cfa-status-brief">
                                            Fewer CFAs than reported — verify referrals or the number entered.
                                        </div>
                                    </div>
                                @else
                                    <div class="cfa-status-cell cfa-status-cell--neutral">
                                        ...
                                        <div class="cfa-status-brief">
                                            No CFA submissions via your referral on this visit date (by submission date).
                                        </div>
                                    </div>
                                @endif
                            </td>
