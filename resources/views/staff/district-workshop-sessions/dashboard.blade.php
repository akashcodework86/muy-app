...
@section('title', 'District level workshop dashboard')
        ...
        <form method="get" class="tp-filters">
            ...
            <div class="tp-filter-actions">
                ...
                @if (auth()->user()->role === 'district_staff')
                    <a href="{{ route('staff.district-workshop-sessions.create') }}" class="tp-btn--secondary">New entry</a>
                @endif
            </div>
        </form>
    </div>
                    ...
                    <td>
                        <div class="tp-row-actions">
                            <a class="tp-btn--view" href="{{ match ($currentRole ?? auth()->user()->role) {
                                'state_admin' => route('admin.district-workshop-sessions.show', $row),
                                'state_staff' => route('spoc.district-workshop-sessions.show', $row),
                                default => route('staff.district-workshop-sessions.show', $row),
                            } }}">View</a>
