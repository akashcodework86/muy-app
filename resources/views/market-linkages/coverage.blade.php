...
@section('content')
    ...
    <div class="mlc-shell">
        ...
        <form method="get" action="{{ route($routePrefix.'.index') }}" class="mlc-toolbar">
            ...
            <a href="{{ route($routePrefix.'.index') }}" class="mlc-btn mlc-btn--secondary">Clear filters</a>
