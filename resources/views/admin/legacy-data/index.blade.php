...
<div class="ld-page">
    ...
    <div class="ld-breakdowns">
        <section class="ld-breakdown">
            <div class="ld-breakdown-head"><strong>Year-wise count</strong><small>Unique beneficiaries and total service deliveries under the current filters</small></div>
        ...
        <section class="ld-breakdown">
            <div class="ld-breakdown-head"><strong>District-wise count</strong><small>Home district of the beneficiary; click a district for its detailed list</small></div>
