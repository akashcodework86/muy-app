@php
    ...
    $activeNav = match (true) {
        ...
        str_starts_with($r, 'admin.case-study-shortlists.') => 'case-study-shortlists',
        str_starts_with($r, 'hub.case-study-shortlists.') => 'case-study-shortlists',
        str_starts_with($r, 'staff.case-study-shortlists.') => 'case-study-shortlists',
        ...
        str_starts_with($r, 'staff.mentorship-requests') => 'mentorship-requests-dashboard',
    ...
    $hubServiceGroupActive = in_array($activeNav, ['case-study-shortlists', 'community-org-outreach-submit', 'community-org-outreach-dashboard', 'market-linkage-dashboard', 'line-department-meetings-submit', 'line-department-meetings-dashboard', 'mentorship-requests-dashboard'], true);
    ...
    $ico = [
        ...
        'image'       => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="8.5" cy="10" r="1.5"/><path d="m21 15-4.5-4.5L9 18"/></svg>',
